...
int main()
{
	...
	string Str1 = "CRATE", Str2 = "TRACE";
	cout << "Example 1 : " << endl;
	cout << "Finding similarities between " << Str1 << " and " << Str2 << "." << endl;
	Jaro_Winkler_Algo(Str1, Str2);
	
	string Str3= "RARE", Str4 = "RAIR";
	cout << "Example 2 : " << endl;
	cout << "Finding similarities between " << Str3 << " and " << Str4 << "." << endl;
	Jaro_Winkler_Algo(Str3, Str4);
	
	string Str5 = "Thhomas", Str6 = "Thomas";
	cout << "Example 3 : " << endl;
	cout << "Finding similarities between " << Str5 << " and " << Str6 << "." << endl;
	Jaro_Winkler_Algo(Str5, Str6);
	
	string Str7 = "Taresa", Str8 = "teresa";
	cout << "Example 4 : " << endl;
	cout << "Finding similarities between " << Str7 << " and " << Str8 << "." << endl;
	Jaro_Winkler_Algo(Str7, Str8);

	string Str9 = "johnathan", Str10 = "jonathan";
	cout << "Example 5 : " << endl;
	cout << "Finding similarities between " << Str9 << " and " << Str10 << "." << endl;
	Jaro_Winkler_Algo(Str9, Str10);
